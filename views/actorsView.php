...
?>
    <form action="index.php?action=saveActor" method="post">
        ...
        <label for="photoUrl1">Photo (lien) :</label>
        <input type="url" id="photoUrl1" name="photoUrl" data-preview-target="imagePreview1" required maxlength="255">
        <img id="imagePreview1" class="imagePreview" src="">
