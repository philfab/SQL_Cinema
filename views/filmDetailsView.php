...
<form class="form-film" action="index.php?action=<?= $actionUpdate ?>" method="post">
    <div class="form-row">
        ...
        <input type="text" id="titre" name="titre" class="validate-input" value="<?= $filmDetails['titre'] ?>" required
    ...
    <div class="form-row container-casting">
        <div class="form-row">
            ...
            <select id="realisateur" name="realisateur">
                ...
                <option value="<?= $realisateur['id_realisateur']; ?>" <?php if ($realisateur['id_realisateur'] == $filmDetails['id_realisateur']) {
                                                                                    echo 'selected';
                                                                                } ?>>
        ...
        <div class="form-row">
            ...
            <input type="text" id="affiche" name="affiche" value="<?= $filmDetails['affiche'] ?>s" required
                maxlength="255">
        </div>
    </div>
        ...
        <div id="casting-content">
            ...
            <div class="scroll-container">
                ...
                <div class="actor-container">
                    <input type="checkbox" id="actor-<?= $acteur['id_acteur']; ?>"
                        onclick="toggleRoleSelect(this, '<?= $acteur['id_acteur']; ?>', <?= in_array($acteur['id_acteur'], array_column($filmCasting, 'id_acteur')) ? 'true' : 'false' ?>)">
                    <label
                        for="actor-<?= $acteur['id_acteur'] ?>"><?= $acteur['prenom'] . ' ' . $acteur['nom'] ?></label>
                    <select id="role-select-<?= $acteur['id_acteur'] ?>" name="actor[<?= $acteur['id_acteur'] ?>][role]"
                        disabled>
    ...
    <div class="form-row container-casting">
        ...
        <div class="film-data">
            ...
            <input type="number" id="duree" name="duree" min="60" max="300" value="<?= $filmDetails['duree'] ?>"
                required>
        </div>
        <div class="film-data">
    ...
    <div id="kinds-modal" style="display:none;">
        <div id="kinds-content">
            ...
            <div class="kinds-container">
                ...
                <div>
                    <input type="checkbox" id="genre-<?= $kind['id_genre']; ?>" name="genres[]"
                        value="<?= $kind['id_genre']; ?>"
                        <?= in_array($kind['id_genre'], array_column($filmGenres, 'id_genre')) ? 'checked' : ''; ?>>
